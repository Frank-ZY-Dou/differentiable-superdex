...
angular velocities for the new size, keeping the angular rate); `get_step_jacobian` assumes two
consecutive steps of the same size; rotational gradients of rigid bodies under torques carry the
