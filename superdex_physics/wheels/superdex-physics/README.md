...
| `example_diffsim_tactile.py` | Differentiable tactile control of the XHand1: its 600-taxel fingertip compression map is a differentiable function of the state; from the settled ~12 N grip the twelve joint targets of the 3 N grip found by the force task are recovered from the tactile map alone. |
