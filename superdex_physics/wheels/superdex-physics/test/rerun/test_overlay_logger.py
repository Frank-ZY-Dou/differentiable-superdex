...
try:
    import arvr  # noqa: F401 - the timeline support module below is Meta-internal
except ImportError as error:  # pragma: no cover - the open-source export
    raise unittest.SkipTest(
        "rerun overlay timeline tests need Meta's internal rerun_timeline_test_support"
    ) from error
